...
import { ScriptJSON } from "./remotion/types";
...
// google fonts injected at runtime — Playfair Display + DM Sans
...
export default function App() {
  ...
  const page: React.CSSProperties = {
    ...
    padding: 40,
    // subtle noise grain overlay via background-image
  ...
  if (stage === "loading") return (
    <div style={page}>
      <div style={{ textAlign: "center", width: "100%", maxWidth: 460 }}>
        ...
        <p style={{ fontSize: 13, color: "#44445a", letterSpacing: 0.3 }}>
          {progress.msg}
        </p>
      </div>
    </div>
